...
def minmax(x):
        ...
        return(x)
bulk = minmax(pd.read_csv('/lustre/wangjc01/huzixin/deconv/data/bulk_adni.csv'))
ref = minmax(pd.read_csv('/lustre/wangjc01/huzixin/deconv/data/ref_adni.csv'))
...
pd.DataFrame(bulk_encoded).to_csv('/lustre/wangjc01/huzixin/deconv/log/rlt_adni/%s.bulk_encoded'%fo,index=0)
pd.DataFrame(ref_encoded).to_csv('/lustre/wangjc01/huzixin/deconv/log/rlt_adni/%s.ref_encoded'%fo,index=0)
